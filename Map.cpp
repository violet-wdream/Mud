...
void Map::initEnemy(int position, Enemy enemy[3])
{
	switch (position)
	{
	case 0:enemy[0].name = "0. "; enemy[1].name = "1. "; enemy[2].name = "2. ";//spring
		break;
	case 1:enemy[0].name = "0. "; enemy[1].name = "1. "; enemy[2].name = "2. "; //dirtmouth
		break;
	case 2:enemy[0].name = "0.龙牙哥"; enemy[1].name = "1. "; enemy[2].name = "2. ";      //crossroads
		break;
	case 3:enemy[0].name = "0.背叛领主"; enemy[1].name = "1.螳螂战士";  enemy[2].name = "2. ";     //mantistown
		break;
	case 4:enemy[0].name = "0.苔藓流浪者";  enemy[1].name = "1. "; enemy[2].name = "2. ";//queengarden
		break;
	case 5:enemy[0].name = "0.水晶守卫"; enemy[1].name = "1.躯壳矿工";   enemy[2].name = "2. ";//crystalpeak
		break;
	case 6:enemy[0].name = "0.国王傀儡";  enemy[1].name = "1. "; enemy[2].name = "2. ";//palepalace
		break;
	case 7:enemy[0].name = "0.空洞骑士";  enemy[1].name = "1. "; enemy[2].name = "2. "; //blackeggpalace 
		break;
	default:
		break;
	}
